...
function getReactVersion() {
  const parts = React15.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
function useTimeout() {
  ...
  const handleRef = (0, import_react14.useRef)();
...
var Carousel = React28.forwardRef(({
  ...
  const nextDirectionRef = (0, import_react15.useRef)(null);
  const [direction, setDirection] = (0, import_react15.useState)("next");
  const [paused, setPaused] = (0, import_react15.useState)(false);
  const [isSliding, setIsSliding] = (0, import_react15.useState)(false);
  const [renderedActiveIndex, setRenderedActiveIndex] = (0, import_react15.useState)(activeIndex || 0);
  ...
  const prev = (0, import_react15.useCallback)((event) => {
    if (isSliding) {
      return;
    }
  ...
  const elementRef = (0, import_react15.useRef)();
  ...
  const handleEnter = (0, import_react15.useCallback)((node) => {
    triggerBrowserReflow(node);
    onSlide == null || onSlide(renderedActiveIndex, slideDirection);
  }, [onSlide, renderedActiveIndex, slideDirection]);
  const handleEntered = (0, import_react15.useCallback)(() => {
    setIsSliding(false);
    onSlid == null || onSlid(renderedActiveIndex, slideDirection);
  ...
  const handleMouseOver = (0, import_react15.useCallback)((event) => {
    if (pause === "hover") {
      setPaused(true);
    }
    onMouseOver == null || onMouseOver(event);
  }, [pause, onMouseOver]);
  const handleMouseOut = (0, import_react15.useCallback)((event) => {
    setPaused(false);
    onMouseOut == null || onMouseOut(event);
  }, [onMouseOut]);
  const touchStartXRef = (0, import_react15.useRef)(0);
  const touchDeltaXRef = (0, import_react15.useRef)(0);
  const touchUnpauseTimeout = useTimeout();
  const handleTouchStart = (0, import_react15.useCallback)((event) => {
  ...
  const handleTouchMove = (0, import_react15.useCallback)((event) => {
  ...
  const handleTouchEnd = (0, import_react15.useCallback)((event) => {
    if (touch) {
  ...
  const intervalHandleRef = (0, import_react15.useRef)();
  (0, import_react15.useEffect)(() => {
  ...
  const indicatorOnClicks = (0, import_react15.useMemo)(() => indicators && Array.from({
    length: numChildren
  }, (_, index) => (event) => {
...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  const wasPropRef = (0, import_react16.useRef)(propValue !== void 0);
  const [stateValue, setState] = (0, import_react16.useState)(defaultValue);
  ...
  return [isProp ? propValue : stateValue, (0, import_react16.useCallback)((...args) => {
...
function useSafeState(state) {
  const isMounted = useMounted();
  return [state[0], (0, import_react17.useCallback)((nextState) => {
    if (!isMounted()) return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react18.useRef)(modifiers);
  const popperInstanceRef = (0, import_react18.useRef)();
  const update = (0, import_react18.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react18.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react18.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react18.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react18.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop2, {
  ...
  const preventMouseClickOutsideRef = (0, import_react19.useRef)(false);
  const waitingForTrigger = (0, import_react19.useRef)(false);
  const handleMouseCapture = (0, import_react19.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context4 = (0, import_react20.useContext)(DropdownContext_default);
...
var $b5e257d569688ac6$var$SSRContext = (0, import_react21.default).createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = (0, import_react21.default).createContext(false);
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
  let cur = (0, import_react21.useContext)($b5e257d569688ac6$var$SSRContext);
  let counter = $b5e257d569688ac6$var$useCounter(cur === $b5e257d569688ac6$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react21.useState)(true);
  ...
  return (0, import_react21.default).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
    value
  }, (0, import_react21.default).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
    value: isSSR
  }, props.children));
}
var $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
  if (typeof (0, import_react21.default)["useId"] === "function") {
    if (!$b5e257d569688ac6$var$warnedAboutSSRProvider) {
      console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
      $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
    }
    return (0, import_react21.default).createElement((0, import_react21.default).Fragment, null, props.children);
  }
  return (0, import_react21.default).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
var $b5e257d569688ac6$var$canUseDOM = Boolean(typeof window !== "undefined" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react21.useContext)($b5e257d569688ac6$var$SSRContext);
  let ref = (0, import_react21.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react21.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = (0, import_react21.default).useId();
  let [didSSR] = (0, import_react21.useState)($b5e257d569688ac6$export$535bd6ca7f90a273());
  let prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, import_react21.default)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react21.default)["useSyncExternalStore"] === "function") return (0, import_react21.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
  return (0, import_react21.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
...
var Context = (0, import_react24.createContext)(canUseDOM_default ? window : void 0);
var WindowProvider = Context.Provider;
function useWindow() {
  return (0, import_react24.useContext)(Context);
}
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react25.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react25.useRef)(null);
  const focusInDropdown = (0, import_react25.useRef)(false);
  const onSelectCtx = (0, import_react25.useContext)(SelectableContext_default);
  const toggle = (0, import_react25.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context4 = (0, import_react25.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react25.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
function useWrappedRefWithWarning(ref, componentName) {
  if (false) return ref;
  const warningRef = (0, import_react26.useCallback)((refValue) => {
...
var DropdownMenu2 = React40.forwardRef(({
  ...
  let alignEnd = false;
  const isNavbar = (0, import_react27.useContext)(NavbarContext_default);
  const prefix = useBootstrapPrefix(bsPrefix, "dropdown-menu");
  const {
    align: contextAlign,
    drop,
    isRTL
  } = (0, import_react27.useContext)(DropdownContext_default2);
...
var DropdownToggle2 = React41.forwardRef(({
  ...
  const dropdownContext = (0, import_react28.useContext)(DropdownContext_default);
...
var FigureImage = React45.forwardRef(({
  className,
  fluid = true,
  ...props
...
var FigureCaption = React46.forwardRef(({
  className,
  bsPrefix,
...
var FormCheck = React52.forwardRef(({
  ...
  const innerFormContext = (0, import_react32.useMemo)(() => ({
...
var FormLabel = React56.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime52.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
var RTGTransition = React67.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose6(_ref, _excluded5);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime64.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime65.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime65.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime65.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react43.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime66.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime66.jsx)("div", Object.assign({}, dialogProps, {
  ...
  return (0, import_jsx_runtime66.jsx)(import_jsx_runtime66.Fragment, {
    children: import_react_dom3.default.createPortal((0, import_jsx_runtime66.jsxs)(import_jsx_runtime66.Fragment, {
...
var AbstractModalHeader = React74.forwardRef(({
  ...
  return (0, import_jsx_runtime71.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime70.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick
    })]
...
var Modal2 = React77.forwardRef(({
  ...
  const renderBackdrop = (0, import_react45.useCallback)((backdropProps) => (0, import_jsx_runtime74.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React85.forwardRef(({
  ...
  const renderBackdrop = (0, import_react50.useCallback)((backdropProps) => (0, import_jsx_runtime82.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React86.forwardRef(({
  ...
  const context4 = (0, import_react51.useContext)(NavbarContext_default);
  const handleHide = useEventCallback(() => {
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime99.jsxs)(import_jsx_runtime98.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react57.cloneElement)(children, triggerProps), (0, import_jsx_runtime97.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react59.useContext)(TabContext_default);
...
var ToastHeader = React116.forwardRef(({
  ...
  const context4 = (0, import_react61.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
